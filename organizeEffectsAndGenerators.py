...
# Loop for both Effects and Generators folders
folders = ["Effects","Generators"]
for x in folders:

    # Print current folder getting processed
    print(f"Currently processing {x}")

    # Checks and Defines the path to the input folder
    if os.path.isdir(win_reg_user_data):
        input_folder = f"{win_reg_user_data}\\FL Studio\\Presets\\Plugin database\\Installed\\{x}\\New"
        print(f"{x} Input Folder - Found via registry")
    elif os.path.isdir(f"C:\\Users\\{os.environ['USERNAME']}\\Documents\\Image-Line"):
        input_folder = f"C:\\Users\\{os.environ['USERNAME']}\\Documents\\Image-Line\\FL Studio\\Presets\\Plugin database\\Installed\\{x}\\New"
        print(f"{x} Input Folder - Local Documents")
    elif os.path.isdir(f"C:\\Users\\{os.environ['USERNAME']}\\OneDrive\\Documents\\Image-Line"):
        input_folder = f"C:\\Users\\{os.environ['USERNAME']}\\OneDrive\\Documents\\Image-Line\\FL Studio\\Presets\\Plugin database\\Installed\\{x}\\New"
        print(f"{x} Input Folder - OneDrive Documents")
    else:
        input_folder = input("Enter the path to the input folder: ")
        print(f"{x} Input Folder - Custom Folder")

    # Checks and Defines the path to the output folder
    if os.path.isdir(win_reg_user_data):
        output_folder = f"{win_reg_user_data}\\FL Studio\\Presets\\Plugin database\\{x}\\USER"
        print(f"{x} Output Folder - Found via registry")
    elif os.path.isdir(f"C:\\Users\\{os.environ['USERNAME']}\\Documents\\Image-Line"):
        output_folder = f"C:\\Users\\{os.environ['USERNAME']}\\Documents\\Image-Line\\FL Studio\\Presets\\Plugin database\\{x}\\USER"
        print(f"{x} Output Folder - Local Documents")
    elif os.path.isdir(f"C:\\Users\\{os.environ['USERNAME']}\\OneDrive\\Documents\\Image-Line"):
        output_folder = f"C:\\Users\\{os.environ['USERNAME']}\\OneDrive\\Documents\\Image-Line\\FL Studio\\Presets\\Plugin database\\{x}\\USER"
        print(f"{x} Output Folder - OneDrive Documents")
    else:
        output_folder = input("Enter the path to the output folder: ")
        print(f"{x} Output Folder - Custom Folder")
